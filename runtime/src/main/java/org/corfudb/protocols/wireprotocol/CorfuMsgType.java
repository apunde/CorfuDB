...
public enum CorfuMsgType {
    ...
    STATE_TRANSFER_REQUEST(35, new TypeToken<CorfuPayloadMsg<RangeWriteMsg>>() {}),
    ...
    STATE_TRANSFER_STATUS_REQUEST(39, new TypeToken<CorfuPayloadMsg<RangeWriteMsg>>() {}),
    STATE_TRANSFER_STATUS_RESPONSE(40, new TypeToken<CorfuPayloadMsg<RangeWriteMsg>>() {}),
