...
public class CorfuCompileProxy<T> implements ICorfuSMRProxyInternal<T> {
    ...
    public CorfuCompileProxy(@NonNull CorfuRuntime rt, @NonNull UUID streamID,
                             @NonNull Class<T> type, @NonNull Object[] args,
                             @NonNull ISerializer serializer,
                             @NonNull Map<String, ICorfuSMRUpcallTarget<T>> upcallTargetMap,
                             @NonNull Map<String, IUndoFunction<T>> undoTargetMap,
                             @NonNull Map<String, IUndoRecordFunction<T>> undoRecordTargetMap,
                             @NonNull Set<String> resetSet
    ) {
        this.rt = rt;
