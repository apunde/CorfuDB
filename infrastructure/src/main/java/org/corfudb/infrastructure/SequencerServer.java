...
import org.corfudb.protocols.wireprotocol.StreamsIdRequest;
...
public class SequencerServer extends AbstractServer {
     ...
     * address space view by replacing streams address vie with compacted one
    ...
    /**
     * Service an incoming request for IDs of streams.
     */
    @ServerHandler(type = CorfuMsgType.STREAMS_ID_REQUEST)
    private void handleStreamsIdRequest(CorfuPayloadMsg<StreamsAddressRequest> msg,
                                        ChannelHandlerContext ctx, IServerRouter r) {
