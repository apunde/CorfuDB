...
@Slf4j
public class CompactionAwareTransferBatchProcessor extends TransferBatchProcessor {


    public CompactionAwareTransferBatchProcessor(StreamLog streamLog) {
        super(streamLog);
    }

    @Override
    Supplier<CompletableFuture<Result<Long, StateTransferException>>> getErrorHandlingPipeline(StateTransferException exception, RuntimeLayout runtimeLayout) {
